;(function(psdWidth,dividendFontSize,maxRootFontSize){
	...
	function setRem(){
		// document.documentElement.getBoundingClientRect() iOS4.0+ 安卓2.0+  https://developer.mozilla.org/zh-CN/docs/Web/API/Element.getBoundingClientRect
		var rootFontSize = Math.min(
			(hasGbcr?de[gbcr]().width:w.innerWidth)/(psdWidth/dividendFontSize)
			,maxRootFontSize
		)
